...
public class Main {
	...
	public static void heapify(int ar[], int n, int i) {
		...
		//2° step verificare che left e right siano effettivamente minori di root (minori perch� stiamo realizzando un Max-Heap)
		//Verifichiamo prima che il figlio sinistro sia effettivamente pi� piccolo del suo parent
